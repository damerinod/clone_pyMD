...
R = 1.
# tamano del sistema
LX = 50*R  #112.09982432795857*R
LY = 50*R  #112.09982432795857*R
...
listacol = []  # lista de tiempos de colision entre particulas, acompanado de las particulas que colisionan
listacol_orden = []
ij = []
    ...
    if drdv > 0:
        ...
        if raiz < 0:
            ...
            if math.fabs(xicol) > LXR:
                ...
                bisect.insort(listacol,[vdt,[i,j]]) # inserta de manera ordenada
...
##     nombre='/home/willy/Documentos/codigo_git/pyMD/results/xy'+inum+'.dat'
...
##     nombre='/home/willy/Documentos/codigo_git/pyMD/results/vxvy'+inum+'.dat'
...
def write_micr_state(ja):
    ...
    nombre='/home/willy/Documentos/codigo_git/clone_pyMD/results/xy'+inum+'.dat'
    ...
    # formatea el nombre de archivo de posiciones 
    nombre='/home/willy/Documentos/codigo_git/clone_pyMD/results/vxvy'+inum+'.dat'
    with open(nombre,'w') as archivo:
        for i in range(npart):
            archivo.write('{0:10.2f} {1:10.2f}\n'.format(vx[i], vy[i]))
    archivo.closed
...
def write_averages_evol():
    nombre='/home/willy/Documentos/codigo_git/clone_pyMD/results/temp.dat'
